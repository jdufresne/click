...
def get_terminal_size():
    ...
    .. deprecated:: 8.0
        Will be removed in 8.1. Use :func:`shutil.get_terminal_size` instead.
    """
    import shutil
    import warnings

    warnings.warn(
        "click.get_terminal_size() is deprecated and will be removed in Click "
        "8.1. Please use shutil.get_terminal_size() instead.",
        DeprecationWarning,
        stacklevel=2,
    )
